...
function UseRefHook() {
  ...
  return (
    <div>
      ...
      <button className="ml-2 p-2 bg-gray-500 text-white rounded hover:bg-gray-700" onClick={() => console.warn('Current Count:', count, 'Previous Count:', previousCount.current)}>Console use Ref</button>
