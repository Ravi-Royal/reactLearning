...
export const INITIAL_CHECKLIST_ITEMS: ChecklistItem[] = [
  {
    id: 'repaymentPriority',
    label: CHECKLIST_ITEM_LABELS.REPAYMENT_PRIORITY,
    checked: false,
  ...
  {
    id: 'personalDuration',
    label: CHECKLIST_ITEM_LABELS.PERSONAL_DURATION,
    checked: false,
    category: CHECKLIST_CATEGORIES.AI,
  },
  {
    id: 'personalIncome',
    label: CHECKLIST_ITEM_LABELS.PERSONAL_INCOME,
    checked: false,
    category: CHECKLIST_CATEGORIES.AI,
  },
];
