  ...
  return (
    <div className={RESPONSIVE_PATTERNS.padding.page}>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <p className={`${RESPONSIVE_PATTERNS.text.base} text-gray-600 mt-2`}>Learn about bonds and fixed income investments.</p>
        <div className={RESPONSIVE_PATTERNS.margin.section}>
          <p className={`${RESPONSIVE_PATTERNS.text.base} text-gray-700 mb-4`}>This is a placeholder for bonds information.</p>
