...
function StockCheckList() {
  const [checklistItems, setChecklistItems] = useState([
    ...
    { id: 'pedata', label: 'Less PE (<10)', checked: false, category: CHECKLIST_CATEGORIES.AI },
    { id: 'PBratio', label: 'Less price to book', checked: false, category: CHECKLIST_CATEGORIES.AI },
    { id: 'PEAdPBratio', label: 'Lower PE and lower Price to Book is for sure better stock', checked: false, category: CHECKLIST_CATEGORIES.AI },
